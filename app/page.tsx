...
export default function Home() {
    ...
    const links = [{
        ...
        {label: 'Deezer', link: 'https://dzr.page.link/abMmAa34Hausb7ht8', color: 'secondary'},
        {label: 'qobuz', link: 'https://open.qobuz.com/album/wyclop3sa2yzb', color: 'default'}]
                ...
                >
                    ...
                    <div className="flex">
                        <Button
                            ...
                            variant="faded"
                        >
                            Mira &#34;Galaxias&#34; el video mas reciente <ArrowRightIcon/>
                        </Button>
                    </div>
                </FadeContent>
                ...
                >
                    ...
                    <div className="flex">
                        <Button
                            ...
                            onPress={onOpen}
                        >
                            Escucha &#34;Te Quiero A Ti&#34;<ArrowRightIcon/>
                        </Button>
                    </div>
                </FadeContent>
                <div className="w-full md:w-1/2 flex px-8 md:px-10">
                    <Image
                        alt="Travel with a song in the soul"
                        radius="none"
                        src={"/images/newest.webp"}
                    />
                </div>
            </div>
            <div
                className="bg-foreground text-background w-full flex flex-wrap items-center justify-center text-center">
                <div className="w-full md:w-1/2 min-h-[40vh] flex flex-col items-center justify-center">
                    <h3 className="text-4xl md:text-5xl w-full">Contactame</h3>
                    <Link className={'text-background text-2xl underline mt-8'} href={"mailto:pablo.marte37@gmail.com"}
                    ...
                    {(onClose) => (
                        <>
                            ...
                            <ModalBody className="flex flex-col items-center justify-center text-center">
                                {links.length > 0 ? links.map(element => {
                                    return <LinksList key={element.label} label={element.label} link={element.link}
                                                      color={element.color}/>
                                }) : <p>Cooming Soon</p>}
                            </ModalBody>
                            <ModalFooter>
